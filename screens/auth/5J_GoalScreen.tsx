...
type Props = {
  navigation: NativeStackNavigationProp<RootStackParamList, '5J_Goal'>;
};
...
const options = [
  ...
  'ENHANCE SPORT-SPECIFIC STRENGTH',
  'BODYBUILDING',
  'POWERLIFTING',
];
  ...
  return (
    <ImageBackground source={require('../../assets/images/whatisyourgoal.png')} style={styles.bg}>
      <SafeAreaView style={styles.overlay}>
        ...
        <Text style={styles.subtitle}>Crack your shell, break your limits.</Text>
