...
type Props = {
  navigation: NativeStackNavigationProp<RootStackParamList, '5I_TrainLength'>;
};
...
export default function TrainLengthScreen({ navigation }: Props) {
  const [selected, setSelected] = useState<string | null>(null);

  return (
    <ImageBackground source={require('../../assets/images/howlongtrain.png')} style={styles.bg}>
      <SafeAreaView style={styles.overlay}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          <Text style={styles.backArrow}>‹</Text>
        </TouchableOpacity>
        <Text style={styles.title}>HOW LONG DO/CAN YOU WORKOUT EACH SESSION?</Text>
        ...
        <TouchableOpacity
          ...
          disabled={!selected}
          onPress={() => navigation.navigate('5J_Goal')}
        >
